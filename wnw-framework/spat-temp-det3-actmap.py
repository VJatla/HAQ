...
USAGE
-----
python spat-temp-det3-actmap.py /home/vj/Dropbox/AOLME_Activity_Maps/Writing/C1L1P-E/20170302/C1L1P-E_Mar02_actmap.json
"""
...
class ActMaps:
    ...
    def create_wgt_map_from_gt_excel(self):
    ...
    def _prepare_algdf(self):
        ...
        1. Remove nowriting
        2. Join writing activity that are next to each other
        ...
        # Removing nowriting instances
        algdf = self.algdf.copy()
        algdf.drop(algdf.index[algdf['activity'] == 'nowriting'], inplace=True)

        # Join writing instances that are next to each other.
    ...
    def _join_algdf_activities(self, df, fth = 1):
        """Join writing activities that are very close to each other.
    ...
    def create_w_maps(self, map_type):
...
if __name__ == "__main__":
    ...
    gtfig = act_maps.create_w_maps("gt")
    algfig = act_maps.create_w_maps("alg")
    ...
    gtfig = act_maps.create_wgt_map_from_gt_excel()
