...
/mnt/twotb/aolme_datasets/tynty_table_roi/resized_224_20fps/val_videos_all.txt
...
4 \
/mnt/twelvetb/vj/dyadic_nn/wnw_table_roi/resized_224_20fps/Dec26/run0/best_epoch57.pth \
/mnt/twotb/aolme_datasets/wnw_table_roi/resized_224_20fps/tst_videos_all.txt
...
def main():
    ...
    # Loading network
    net = load_net(best_ckpt, ndyads, input_shape_20fps)
