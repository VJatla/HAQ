...
/mnt/twotb/aolme_datasets/tynty_table_roi/resized_224_10fps/val_videos_all.txt
...
4 \
/mnt/twelvetb/vj/dyadic_nn/wnw_table_roi/resized_224_10fps/Dec26/run6/best_epoch61.pth \
/mnt/twotb/aolme_datasets/wnw_table_roi/resized_224_10fps/tst_videos_all.txt
...
def main():
    ...
    input_shape_10fps = [3, 30, 224, 224]

    # GPU device. Defaulting to GPU 0
    device = get_cuda_device(0)

    # Loading network
    net = load_net(best_ckpt, ndyads, input_shape_10fps)
    ...
    print(f"Writing {png_path}/{png_name}")
