...
def main():
    ...
    training_params = {
        "input_shape": tuple(input_shape_10fps),
    ...
    # Build model
    cnn3d_10fps = DyadicCNN3DV2(ndyads, input_shape_10fps)

    # Loss and optimizer
    criterion = nn.BCELoss()  # Using Binary Cross Entropy loss
    # optimizer = optim.SGD(cnn3d_10fps.parameters(), lr=0.01, weight_decay=0.001)
    optimizer = optim.Adam(cnn3d_10fps.parameters())
