...
ann_file_train = ''  # vj
ann_file_val = ''  # vj
ann_file_test = 'data/tynty_one_trim_per_instance_3sec_224/group_leave_one_out/exp2/C1L1P-B/val.txt'  #vj
...
checkpoint_config = dict(interval=3)  # Changed by vj
