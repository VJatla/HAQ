...
ann_file_train = 'data/tynty_one_trim_per_instance_3sec_224/group_leave_one_out/exp2/C1L1P-A/trn.txt'  # vj
ann_file_val = 'data/tynty_one_trim_per_instance_3sec_224/group_leave_one_out/exp2/C1L1P-A/val.txt'  # vj
ann_file_test = ''  #vj
